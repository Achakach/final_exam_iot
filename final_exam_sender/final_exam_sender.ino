...
const char WIFI_SSID[] = "aecdtac";     // CHANGE TO YOUR WIFI SSID
const char WIFI_PASSWORD[] = "11111000";  // CHANGE TO YOUR WIFI PASSWORD
...
const char PUBLISH_TOPIC[] = "66070244/final";       // CHANGE IT AS YOU DESIRE
const char SUBSCRIBE_TOPIC[] = "66070244/final";  // CHANGE IT AS YOU DESIRE
...
void sendToMQTT() {
  ...
  // สร้าง JSON เพย์โหลด เช่น {"temp":27.15,"humid":64.23}
  String payload = String("{\"temp\":") + String(t, 2) + ",\"humid\":" + String(h, 2) + "}";

  mqtt.publish(PUBLISH_TOPIC, payload.c_str());
